...
{
    private static readonly Lazy<IReadOnlyList<JsonConverter>> All = new(() => ImmutableList.Create<JsonConverter>(new InventoryListJsonConverterFactory(), new InventoryTableJsonConverterFactory()));
